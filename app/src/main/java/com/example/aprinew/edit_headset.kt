...
class edit_headset : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        setContentView(R.layout.edit_headset)
        ...
        val ambil = dbtoko.rawQuery("SELECT * FROM headset WHERE id_barang = '$id_produk_terpilih'",null)
        ambil.moveToNext()
        ...
        btn_simpan.setOnClickListener {
            ...
            val mengubah = dbtoko.rawQuery("UPDATE headset SET nama_barang='$nama_baru',harga_barang='$harga_baru' WHERE id_barang = '$id_produk_terpilih'",null)
            mengubah.moveToNext()
