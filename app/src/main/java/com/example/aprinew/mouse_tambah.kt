...
class mouse_tambah : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.mouse_tambah)
        ...
        btn_simpan.setOnClickListener {
            ...
            val eksekutor = dbtoko.rawQuery("INSERT INTO mouse (nama_barang,harga_barang)VALUES('$isi_nama','$isi_harga')", null)
