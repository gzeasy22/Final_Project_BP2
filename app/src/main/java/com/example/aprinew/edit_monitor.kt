...
class edit_monitor : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val ambil = dbtoko.rawQuery("SELECT * FROM monitor WHERE id_barang = '$id_produk_terpilih'",null)
        ambil.moveToNext()
        ...
        btn_simpan.setOnClickListener {
            ...
            val mengubah = dbtoko.rawQuery("UPDATE monitor SET nama_barang='$nama_baru',harga_barang='$harga_baru' WHERE id_barang = '$id_produk_terpilih'",null)
            mengubah.moveToNext()
