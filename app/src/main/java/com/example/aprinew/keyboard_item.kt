...
class keyboard_item (val ini: Context, val id:MutableList<String>, val nama:MutableList<String>, val harga:MutableList<String>, val foto:MutableList<Int>) : RecyclerView.Adapter<keyboard_item.ViewHolder> () {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): keyboard_item.ViewHolder {
        val view: View = LayoutInflater.from(parent.context).inflate(R.layout.keyboard_item, parent, false)
    ...
    override fun onBindViewHolder(holder: keyboard_item.ViewHolder, position: Int) {
        ...
        holder.btn_hapus.setOnClickListener {
            ...
            val pindah: Intent = Intent(ini, keyboard_hapus::class.java)
        ...
        holder.btn_edit.setOnClickListener {
            ...
            val pindah1: Intent = Intent(ini, edit_keyboard::class.java)
