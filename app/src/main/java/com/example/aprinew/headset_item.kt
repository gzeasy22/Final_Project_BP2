...
class headset_item (val ini: Context, val id:MutableList<String>, val nama:MutableList<String>, val harga:MutableList<String>,val foto:MutableList<Int>) : RecyclerView.Adapter<headset_item.ViewHolder> () {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): headset_item.ViewHolder {
        val view: View = LayoutInflater.from(parent.context).inflate(R.layout.headset_item, parent, false)
    ...
    override fun onBindViewHolder(holder: headset_item.ViewHolder, position: Int) {
        ...
        holder.btn_hapus.setOnClickListener {
            ...
            val pindah: Intent = Intent(ini, headset_hapus::class.java)
        ...
        holder.btn_edit.setOnClickListener {
            ...
            val pindah1: Intent = Intent(ini, edit_headset::class.java)
